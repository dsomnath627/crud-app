<?php 
// INSERT INTO `notes` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'buy laptop', '  go to store', current_timestamp());
...
// if ($method == "POST") {
  if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    if (isset( $_POST['snoEdit'])){
      ...
      $sql = "ALTER TABLE `notes` CHANGE `sno` `sno` INT(11) NULL;";
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/crud/index.php" method="POST">
            ...
            <div class="mb-3">
              <label for="description">Note describtion</label>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Concact</a>
          </li>
  ...
  <script>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure to deleted this note!")) {
          console.log("yes");
